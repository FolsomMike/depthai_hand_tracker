            ...
            if hand.lm_score > self.tracker.lm_score_thresh:
                ...
                if self.show_landmarks:
                    ...
                    if self.tracker.use_gesture:
                        ...
                        color = {0: (255, 0, 0), 1: (0, 255, 0), 2: (0, 0, 255), 3: (255, 255, 255)}

                        cv2.circle(self.frame, (hand.landmarks[0][0], hand.landmarks[0][1]), radius, color[3], -1)

                        for i in range(1,5):
                            cv2.circle(self.frame, (hand.landmarks[i][0], hand.landmarks[i][1]), radius, color[0], -1)
                        for i in range(5,9):
                            cv2.circle(self.frame, (hand.landmarks[i][0], hand.landmarks[i][1]), radius, color[1], -1)
                        for i in range(9,13):
                            cv2.circle(self.frame, (hand.landmarks[i][0], hand.landmarks[i][1]), radius, color[2], -1)
                        for i in range(13,17):
                            cv2.circle(self.frame, (hand.landmarks[i][0], hand.landmarks[i][1]), radius, color[3], -1)
                        ...
                        cv2.circle(self.frame, (hand.landmarks[0][0], hand.landmarks[0][1]), radius * 2, (0, 0, 255), -1) # debug mks
